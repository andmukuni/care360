...
/**
 * Returns an in-progress Screening Review encounter to the Triage queue.
 */
export default class QueueEncounterBackToTriageFromScreeningReviewAction {
  ...
  async handle(
    ...
    const transition = await db.transaction(async (trx) => {
      ...
      await this.auditService.record({
        encounter,
        actionName: 'returned_to_triage_from_screening_review',
