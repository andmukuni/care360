...
/**
 * Upserts the post-lab screening review draft without advancing the encounter.
 */
export default class SaveScreeningReviewDraftAction {
  ...
  async handle(
    ...
    return db.transaction(async (trx) => {
      ...
      await this.auditService.record({
        encounter,
        actionName: 'screening_review_draft_saved',
