...
/**
 * Returns an in-progress Screening encounter to the Triage queue.
 * Ported from App\Actions\Encounter\QueueEncounterBackToTriageAction.
 */
export default class QueueEncounterBackToTriageAction {
