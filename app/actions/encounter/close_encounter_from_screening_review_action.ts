...
/**
 * Ends an encounter at Screening Review without queueing onward.
 */
export default class CloseEncounterFromScreeningReviewAction {
  ...
  async handle(
    ...
    await db.transaction(async (trx) => {
      ...
      await this.auditService.record({
        encounter,
        actionName: 'encounter_closed_from_screening_review',
      ...
      staffQueueBroadcast.notifyStages(
        [EncounterStage.ScreeningReview, EncounterStage.Completed],
        trx
      )
    })
