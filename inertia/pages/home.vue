...
<template>
  ...
  <div class="pt-4 h-full flex flex-col">
    ...
    <div class="isolate mt-10 max-w-screen-xl mx-auto px-16 xl:px-8 grid grid-cols-1 xl:grid-cols-2 xl:grid-rows-3 gap-8">
      <article class="row-span-3 relative p-6 shadow-sm hover:shadow theme-surface border border-sand-7 hover:border-sand-8 rounded-2xl dark:border-transparent transition ease-in-out duration-700 group flex flex-col gap-8">
      ...
      <article class="relative p-6 shadow-sm hover:shadow theme-surface border border-sand-7 hover:border-sand-8 rounded-2xl dark:border-transparent transition ease-in-out duration-700 group flex flex-row gap-4">
        <div class="shrink-0 w-10 h-10 bg-primary/20 rounded-md flex justify-center items-center">
          <svg class="h-6 w-6 fill-primary" viewBox="0 0 256 256">
            <path
              fill="currentColor"
    ...
    <div class="grow mt-10 mb-8 px-16 xl:px-8 max-w-screen-xl mx-auto">
      <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        <article class="relative py-4 px-5 theme-surface border border-transparent rounded-lg hover:border-sand-8 dark:hover:border-transparent hover:shadow-sm transition duration-100 ease-in-out group">
